# Ami Tracker (MDB Module) — Design Notes

This is a MDB module for the AmiAmi Discord Bot. This document contains internal design notes, algorithms, and architecture decisions. For the user-facing description of the bot, see [README.md](README.md).
