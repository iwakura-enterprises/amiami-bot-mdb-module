...
public class ErrorContext {
    ...
    public enum Type {
        ...
        CHANNEL_PRODUCT_LIST_NOT_FOUND,
        SEARCH_PARAMETERS_EMPTY,
        CHANNEL_PRODUCT_LIST_DUPLICATE_NAME,
        WISHLIST_LIMIT_REACHED,
        WISHLIST_ENTRY_LIMIT_REACHED,
        CHANNEL_PRODUCT_LIST_LIMIT_REACHED;
    }
}
